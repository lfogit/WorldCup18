    ...
    <table width="90%" align="center" style="border-spacing: 10px;">
        <tr>
            <td id="commu" width="100%" align="left">
                ...
                <font style="font-size: 15px;">Ce site permet la réalisation de pronostics sur la coupe du monde de football 2018. Vous pouvez ainsi y faire des prévisions sur plusieurs indicateurs et résultats.<br/><br/>
                ...
                <font style="font-size: 15px;">Vous pouvez faire trois sortes de prévisions : sur les matchs, sur le déroulé général de la compétition et sur des statistiques diverses.<br/><br/>
                ...
                <font style="font-size: 15px;">
                   ...
                   Sur chaque « pari Bonus », vous pouvez marquer un maximum de <b>10 points</b> en fonction de votre proximité à la bonne réponse.<br/><br/>
               </font>
               <font style="font-size: 25px;">Qu'y a-t-il à gagner ?</font><br/><br/>
               <font style="font-size: 15px;">
                    Le site n'a rien à vous offrir si ce n'est le plaisir de la compétition et du challenge ! Plus sérieusement, les perdants payent toujours l'apéro !<br/><br/>
                </font>
            </td>
        </tr>
    </table>
